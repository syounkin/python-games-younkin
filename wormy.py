...
def runGame():
    ...
    startx = random.randint(10, CELLWIDTH - 6)
    starty = random.randint(10, CELLHEIGHT - 6)
    wormCoords = [{'x': startx,     'y': starty},
                  ...
                  {'x': startx - 14, 'y': starty},
                  {'x': startx - 15, 'y': starty},
                  {'x': startx - 16, 'y': starty},
                  {'x': startx - 17, 'y': starty},
                  {'x': startx - 18, 'y': starty},
                  {'x': startx - 19, 'y': starty},
                  {'x': startx - 20, 'y': starty},
                  {'x': startx - 21, 'y': starty},
                  {'x': startx - 22, 'y': starty},
                  {'x': startx - 23, 'y': starty},
                  {'x': startx - 24, 'y': starty},
                  {'x': startx - 25, 'y': starty},
                  {'x': startx - 26, 'y': starty},
                  {'x': startx - 27, 'y': starty},
                  {'x': startx - 28, 'y': starty},
                  {'x': startx - 29, 'y': starty},
                  {'x': startx - 30, 'y': starty},
                  {'x': startx - 31, 'y': starty},
                  {'x': startx - 32, 'y': starty},
                  {'x': startx - 33, 'y': starty},
                  {'x': startx - 34, 'y': starty},
                  {'x': startx - 35, 'y': starty},
                  {'x': startx - 36, 'y': starty},
                  {'x': startx - 37, 'y': starty}]
    direction = RIGHT
